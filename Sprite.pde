public class Sprite {
  ...
  public Sprite (String n, String path, int id, int size, int x, int y) {
    this.charName = n;
    this.dataPath = path;
    this.id = id;
    this.size = size;
  ...
  public void RenderSprite() {
    ...
    image(this.Sprites[index], this.spriteX, this.spriteY,
    this.Sprites[index].width * SCALE, this.Sprites[index].height * SCALE );
